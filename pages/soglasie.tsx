...
// 				предпринимателем Репринец Софией Юрьевной (далее — Оператор). 1.1.
...
// 				может получить о посетителях веб-сайта https://insightify.space 2.
...
// 				средств вычислительной техники. 2.2. Блокирование персональных данных —
...
// 				сети интернет по сетевому адресу https://insightify.space 2.4.
...
// 				персональных данных. 2.6. Обработка персональных данных — любое действие
...
// 				Пользователю веб-сайта https://insightify.space 2.9. Персональные
...
// 				обязанности Оператора 3.1. Оператор имеет право: — получать от субъекта
...
// 				целям их обработки. 5.5. Содержание и объем обрабатываемых персональных
...
// 				заявленным целям их обработки. 5.6. При обработке персональных данных
...
// 				данных. 5.7. Хранение персональных данных осуществляется в форме,
...
// 				информации и/или материалам, содержащимся на веб-сайте Персональные
// 				данные фамилия, имя, отчество электронный адрес номера телефонов
// 				Правовые основания Федеральный закон «Об информации, информационных
// 				технологиях и о защите информации» от 27.07.2006 N 149-ФЗ Виды обработки
// 				персональных данных Сбор, запись, систематизация, накопление, хранение,
// 				уничтожение и обезличивание персональных данных Цель обработки
// 				информирование Пользователя посредством отправки электронных писем
// 				Персональные данные фамилия, имя, отчество электронный адрес номера
// 				телефонов Правовые основания Федеральный закон «Об информации,
...
// 				адрес электронной почты Цель обработки заключение, исполнение и
// 				прекращение гражданско-правовых договоров Персональные данные фамилия,
// 				имя, отчество электронный адрес номера телефонов Правовые основания
// 				Федеральный закон «Об информации, информационных технологиях и о защите
// 				информации» от 27.07.2006 N 149-ФЗ Виды обработки персональных данных
...
// 				электронной почты 7. Условия обработки персональных данных 7.1.
...
// 				электронный адрес Оператора olyasonya1205@icloud.com с пометкой «Отзыв
// 				согласия на обработку персональных данных». 8.5. Вся информация, которая
...
// 				поставщиков услуг. 8.6. Установленные субъектом персональных данных
// 				запреты на передачу (кроме предоставления доступа), а также на обработку
...
// 				интересах, определенных законодательством РФ. 8.7. Оператор при
// 				обработке персональных данных обеспечивает конфиденциальность
// 				персональных данных. 8.8. Оператор осуществляет хранение персональных
...
// 				которому является субъект персональных данных. 8.9. Условием прекращения
...
// 				персональных данных, соответствующие сведения. 11. Конфиденциальность
...
// 				данных, если иное не предусмотрено федеральным законом. 12.
// 				Заключительные положения 12.1. Пользователь может получить любые
...
// 				olyasonya1205@icloud.com. 12.2. В данном документе будут отражены любые
// 				изменения политики обработки персональных данных Оператором. Политика
// 				действует бессрочно до замены ее новой версией. 12.3. Актуальная версия
// 				Политики в свободном доступе расположена в сети Интернет по адресу
// 				https://insightify.space Сведения об операторе: Индивидуальный
// 				предприниматель Репринец София Юрьевна Адрес: 119602, г. Москва,
// 				внутригородская территория города муниципальный округ Тропарево-Никулино
// 				ИНН 972902172811, ОГРНИП 323774600181956, Телефон/Telegram: +79660773337
// 				Е-mail: olyasonya1205@icloud.com Редакция от 16 июня 2023 года СОГЛАСИЕ
// 				НА ОБРАБОТКУ ПЕРСОНАЛЬНЫХ ДАННЫХ Я в соответствии со статьей 9
// 				Федерального закона от 27.07.2006 N 152-ФЗ «О персональных данных» даю
// 				своё согласие Индивидуальному предпринимателю Репринец Софие Юрьевне,
// 				ИНН 972902172811, ОГРНИП 323774600181956, именуемой в дальнейшем
// 				«Оператор», в целях -исполнения Оператором Договора оказания услуг на
// 				условиях Публичной оферты, -публикации отзыва об услугах ИП Репринец
// 				С.Ю., -получения рекламной и информационной рассылки -на
// 				автоматизированную, а также без использования средств автоматизации
// 				обработку и использование своих персональных данных, а именно: -имя,
// 				фамилия, -адрес электронной почты, -номер контактного телефона, -номер
// 				мессенджера WhatsApp/Telegram, -мое фото то есть на совершение действий,
// 				предусмотренных п. 3 ст. 3 Федерального закона от 27.07.2006 N 152-ФЗ «О
// 				персональных данных». Я оставляю за собой право отозвать свое согласие
// 				полностью или частично по моей инициативе на основании личного
// 				письменного заявления, в том числе и в случае ставших мне известных
// 				фактов нарушения моих прав при обработке персональных данных. В случае
