    ...
    <div className={s.wrapper}>  
      ...
      <form className={s.wrapperForm} onSubmit={onSubmit}>
        <div className={s.desc}>
          <p><strong>Шаг 3</strong><br/>Заполните поля ниже, введите ваш актуальный адрес почты и номер телефона. После оплаты ваш заказ прийдет к вам на почту. 
          Доставка инсайтов уже едет к вам! </p>
        </div>
        ...
        />
        {errors.tel && <span className={s.error}>{"Email и телефон должны быть заполнены полностью"}</span>}
